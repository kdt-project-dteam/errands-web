...
import { faHeart, faLocationDot, faTruckFast } from "@fortawesome/free-solid-svg-icons";
        ...
        <>
            <div className="main-banner">
                <div className='banner-left'>
                    ...
                    <button type='button' className='btnOrange btnPush' onClick={() => window.location.href = '/WritePage'}>구인 요청하기</button>
                    <button type='button' className='btnOrange btnPush' onClick={() => window.location.href = '/WritePage'}>구직 요청하기</button>
                </div>
                                        ...
                                        <Link to={`/board/boardDetail/wanter/${data.wanter_board_id}`}>
                                            <div data-aos="fade-left" className='swiper-card card'>
                                                ...
                                                <div className='d-flex'>
                                                    ...
                                                    <p><FontAwesomeIcon icon={faLocationDot} /> : {data.wanter_board_place}</p>
                                                    <p>조회수 : {data.wanter_board_hit}</p>
                                                    <p>작성일 : {data.wanter_board_date.split(' ')[0]}</p>
                                                </div>
                                            </div>
                                    ...
                                    <SwiperSlide>
                                        <div data-aos="fade-left" className='swiper-card card'>
                                            ...
                                            <div className='d-flex rank-div'>
                                                <p>추천 수</p>
                                                <p className='fs-30'><FontAwesomeIcon className='c-red' icon={faHeart} />{data.user_like}</p>
