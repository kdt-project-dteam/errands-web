                ...
                <div className='my-write-container'>
                    <div className="myWrite card">
                        ...
                        <table>
                            ...
                            {wanterPost ? wanterPost.map((data, idx) => {
                                return (
                                    <tr>
                                        <td><Link to={`/board/BoardDetail/wanter/${data.wanter_board_id}`}>{data.wanter_board_title}</Link></td>
                    ...
                    <div className="myWrite card">
                        ...
                        <table>
                            ...
                            <th className="date">날짜</th>
                            <th className="number">조회수</th>
                            {helperPost ? helperPost.map((data, idx) => {
                                return (
                                    <tr>
                                        <td><Link to={`/board/BoardDetail/helper/${data.helper_board_id}`}>{data.helper_board_title}</Link></td>
