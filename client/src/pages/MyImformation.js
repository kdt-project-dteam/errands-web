...
export default function WithDraw() {
  ...
  const myPageUserAxios = async () => {
    ...
    const result = await axios({
      method: "GET",
      url: `${process.env.REACT_APP_DB_HOST}/user/${myPageUser}`,
    });
  ...
  const updateUserData = async () => {
    ...
    const result = await axios({
      method: "PATCH",
      url: `${process.env.REACT_APP_DB_HOST}/user/${myPageUserData.id}`,
      data: formData,
    });
  ...
  const setImg = async (file) => {
    ...
    const result = await axios({
      method: "POST",
      url: `${process.env.REACT_APP_DB_HOST}/user/${myPageUserData.id}/img`,
      data: formData,
    });
