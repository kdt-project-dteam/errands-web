...
export default function WithDraw() {
    ...
    return (
        <div className="MyPage">
            ...
            <div className="body">
                {myPageUserData ? <> <div className="memberImfor">회원정보</div>

                    <div className="imfor">
                        <div>아이디 : {myPageUserData.user_id}</div>
                        <div>닉네임 : {myPageUserData.user_name}</div>
                        <div>유저타입 : {myPageUserData.user_type === 'W' ? '구인' : '구직'}</div>
                    </div>
                    ...
                    <form>
                        <div className="field">
                            <input type="password" id="PW" name='user_pw' onChange={inputChange} value={myPageUserData.user_pw} />
