...
router.delete('/user/:userId', controller.userWithdrawal);

router.patch('/user/:userId', controller.userUpdate);
...
router.delete('/wanter/:boardId/comment/:commentId', controller.delete_wanter_comment);
